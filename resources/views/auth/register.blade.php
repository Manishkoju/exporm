                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('register') }}" aria-label="{{ __('Register') }}">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input type="radio" name="salutation" value="mr"> Male<br>
                                <input type="radio" name="salutation" value="mrs"> Female<br>
                        ...
                        <div class="form-group row">
                            <label for="role" class="col-md-4 control-label">Company</label>
                            <div class="col-md-6">
